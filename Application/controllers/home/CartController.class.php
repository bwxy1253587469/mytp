...
class CartController extends BaseController 
{
	...
	private function checkLogin(){
		...
		return isset($_SESSION['home']);
	}
	public function addAction()
	{
		$cartModel = new CartModel();
		if($cartModel->addToCart())
			$this->jump(U('lst'),'',0);
		else
			$this->jump('','添加错误');
	}
	...
	public function order_ok()
	{
        ...
        $notify_url = "http://www.34.com/index.php/Home/Cart/respond";
        //需http://格式的完整路径，不能加?id=123这类自定义参数
        //页面跳转同步通知页面路径 - 会员在支付宝当支付成功之后跳转到哪个页面
        $return_url = "http://www.34.com/index.php/Home/Cart/success";
		...
		// 生成按钮的HTML代码
		$html_text = $alipaySubmit->buildRequestForm($parameter, "get", "立即以GET方式跳转到阿里巴巴旗下的支付宝网站实现在线的支付功能");
