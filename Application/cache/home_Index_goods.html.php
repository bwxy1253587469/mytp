<?php/*声明assign函数渲染的变量*/?><?php $info=$this->tpl_var["info"];$gpData=$this->tpl_var["gpData"];$gaData1=$this->tpl_var["gaData1"];$gaData2=$this->tpl_var["gaData2"];$page_keywords=$this->tpl_var["page_keywords"];$page_description=$this->tpl_var["page_description"];$page_title=$this->tpl_var["page_title"];$show_nav=$this->tpl_var["show_nav"];$page_css=$this->tpl_var["page_css"];$page_js=$this->tpl_var["page_js"];?><?php include showUrl("index/head"); ?>
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo PUBLIC_PATH; ?>/Home/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo PUBLIC_PATH; ?>/Home/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo PUBLIC_PATH; ?>/Home/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo PUBLIC_PATH; ?>/Home/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?php echo PUBLIC_PATH; ?>/Home/images/relate_view5.jpg" alt="" /></a></dt>
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo $imgUrl.$info['logo']; ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo UPLOAD_PATH.$info['logo'];?>" alt="" width=350px/>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo $imgUrl.$info['logo']; ?>',largeimage: '<?php echo $imgUrl.$info['logo']; ?>'}"><?php $imgUrl.$info['sm_logo']; ?></a>
								</li>
								<?php foreach ($gpData as $k => $v): ?>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo $imgUrl.$v['pic']; ?>',largeimage: '<?php echo $imgUrl.$v['pic']; ?>'}"><?php $imgUrl.$v['sm_pic']; ?></a>
								</li>
								<?php endforeach; ?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?php echo date('Y-m-d H:i:s', $info['addtime']); ?></li>
...
$.ajax({
	type : "GET",
	url : "<?php echo U('ajaxGetPrice'); ?>?goods_id="+goodsId,
...
$.ajax({
	type :"GET",
	url : "<?php echo U('ajaxGetComment'); ?>?goods_id="+goodsId,
	dataType : "json",
	success : function(data)
	{
		if(data.login == 1)
			...
			$(".comment_btn").click(function(){
				...
				$.ajax({
					...
					success : function(data)
					{
						...
						{
							// 先拼出评论的字符串
							var html = $('<div style="display:none;" class="comment_items mt10"><div class="user_pic"><dl><dt><a href=""><img src="'+data.face+'" alt="" /></a></dt><dd><a href="">'+data.email+'</a></dd></dl></div><div class="item"><div class="title"><span>'+data.addtime+'</span><strong class="star star'+data.star+'"></strong></div><div class="comment_content">'+data.content+'</div><div class="btns"><a href="" class="reply">回复(0)</a><a href="" class="useful">有用(0)</a></div></div><div class="cornor"></div></div>');
							// 把评论的内容直接放到页面上
...
function ajaxGetCommentByPageNum()
{
	...
	$.ajax({
		type : "GET",
		url : "<?php echo U('Home/Comment/ajaxGetComment'); ?>?p="+current_comment_page+"&goods_id=<?php echo $info['id']; ?>",
		dataType : "json",
		success : function(data)
		{
			//alert('123');
