<?php/*声明assign函数渲染的变量*/?><?php $typeData=$this->tpl_var["typeData"];$catData=$this->tpl_var["catData"];$brandData=$this->tpl_var["brandData"];$mlData=$this->tpl_var["mlData"];$titleURL=$this->tpl_var["titleURL"];$title=$this->tpl_var["title"];?><?php include showUrl("Index/header"); ?>
<div class="tab-div">
    <div id="tabbar-div">
        <p>
