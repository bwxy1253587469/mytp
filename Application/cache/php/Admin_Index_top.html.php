...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="<?php echo PUBLIC_PATH; ?>/Admin/Images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
        ...
        <div id="send_info">
            ...
            <a href="<?php echo U('login/logout');?>" target="_parent" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
    <ul>
        ...
        <li><a href="<?php echo GROUP_PATH; ?>/Index/main" target="main-frame">起始页</a></li>
        <li><a href="<?php echo GROUP_PATH; ?>/Goods/goodsList" target="main-frame">商品列表</a></li>
        <li><a href="<?php echo GROUP_PATH; ?>/Order/orderList" target="main-frame">订单列表</a></li>
        <li><a href="<?php echo GROUP_PATH; ?>/Comment/commentList" target="main-frame">用户评论</a></li>
        <li><a href="<?php echo GROUP_PATH; ?>/User/userList" target="main-frame">会员列表</a></li>
