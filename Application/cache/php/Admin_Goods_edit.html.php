<?php/*声明assign函数渲染的变量*/?><?php $typeData=$this->tpl_var["typeData"];$catData=$this->tpl_var["catData"];$brandData=$this->tpl_var["brandData"];$mlData=$this->tpl_var["mlData"];$data=$this->tpl_var["data"];$extCatId=$this->tpl_var["extCatId"];$gaData=$this->tpl_var["gaData"];$gpData=$this->tpl_var["gpData"];$titleURL=$this->tpl_var["titleURL"];$title=$this->tpl_var["title"];?><?php include showUrl("Index/header"); ?>
<style>
	    ...
	    <form name="main_form" method="POST" action="" enctype="multipart/form-data">
	    	...
	    	<table class="table_content" cellspacing="1" cellpadding="3" width="100%">
	                    ...
	                    <select name="cat_id">
			    			...
			    			<?php foreach ($catData as $k => $v): 
			    				if($v['id'] == $data['cat_id'])
			    					...
			    					$select = '';
			    			?>
			    				<option <?php echo $select; ?> value="<?php echo $v["id"]; ?>"><?php echo str_repeat('-',$v['level'] * 8); ?><?php echo $v["cat_name"]; ?></option>
			    			<?php endforeach; ?>
			    		</select>
			    		<span class="required">*</span>
	                </td>
	                ...
	                <td>
			    		...
			    		<?php else: ?>
				    		<select name="ext_cat_id[]">
				    			...
				    			?>
				    				<option  value="<?php echo $v["id"]; ?>"><?php echo str_repeat('-',$v['level'] * 8); ?><?php echo $v["cat_name"]; ?></option>
				    			<?php endforeach; ?>
				    		</select>
			    		<?php endif; ?>
	                </td>
	            ...
	            <tr>
	                ...
	                <td>
	                	<img src = "<?php echo UPLOAD_PATH;?><?php echo $data["logo"]; ?>" width = "150px"><br />
	    	...
	    	<table class="table_content" cellspacing="1" cellpadding="3" width="100%" style="display:none;">
	    		...
	    		<tr>
		    		<td>
			    		...
			    		￥<input type="text" size="10" name="mp[<?php echo $v["id"]; ?>]" value="<?php echo $v['price']; ?>" /> 元
		    		</td>
	    		</tr>
	    		<?php endforeach; ?>
	    	</table>
	    	...
	    	<table class="table_content" cellspacing="1" cellpadding="3" width="100%" style="display:none;">
	    		...
	    		<ul id="pics_ul">
		    		...
		    		<li>
			    		...
			    		<img src = "<?php echo UPLOAD_PATH;?><?php echo $v["sm_pic"]; ?>" width = "150px">
		    		</li>
		    		<?php endforeach; ?>
		    	</ul>
	    		</td></tr>
...
$("select[name=type_id]").change(function(){
	...
	if(type_id != "")
	{
		$.ajax({
			...
			url : "<?php echo U('AjaxType');?>?type_id="+type_id,
			dataType : "json",
