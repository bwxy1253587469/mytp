...
<body>
<h1>
<span class="action-span1"><a href="">SHOP管理中心 </a> </span><span id="search_id" class="action-span1"> - 系统信息  </span>
  ...
  <div style="background:#FFF; padding: 20px 50px; margin: 2px;">
    <table align="center" width="400">
      <tr>
        ...
        <!--  <img src="<?php echo PUBLIC_PATH; ?>/Admin/images/information.gif" width="32" height="32" border="0" alt="information" /> -->
          <img src="<?php echo PUBLIC_PATH; ?>/Admin/images/warning.gif" width="32" height="32" border="0" alt="warning" />
       <!--   <img src="a<?php echo PUBLIC_PATH; ?>/Admin/images/confirm.gif" width="32" height="32" border="0" alt="confirm" /> -->
        </td>
