<?php/*声明assign函数渲染的变量*/?><?php $btn=$this->tpl_var["btn"];?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
.explode {
  background:url(<?php echo PUBLIC_PATH; ?>/Admin/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(<?php echo PUBLIC_PATH; ?>/Admin/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(<?php echo PUBLIC_PATH; ?>/Admin/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="<?php echo PUBLIC_PATH; ?>/Admin/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
           <?php if(count($btn)>0):$autoindex=0;foreach($btn as $v):$autoindex++; $v =$v; ?>
            <li class="explode" key="02_cat_and_goods" name="menu">
            <?php echo $v["pri_name"]; ?>
                <ul>
                	<?php if(count($v['children'])>0):$autoindex=0;foreach($v['children'] as $v1):$autoindex++; $v1 =$v1; ?>
                    <li class="menu-item"><a href="/<?php echo $v1['module_name']; ?>/<?php echo $v1['controller_name']; ?>/<?php echo $v1['action_name']; ?>.html" target="main-frame"><?php echo $v1["pri_name"]; ?></a></li>
...
<script type="text/javascript" src="<?php echo PUBLIC_PATH; ?>/Admin/Js/global.js"></script>
<script type="text/javascript" src="<?php echo PUBLIC_PATH; ?>/Admin/Js/utils.js"></script>
<script type="text/javascript" src="<?php echo PUBLIC_PATH; ?>/Admin/Js/transport.js"></script>
